...
def print_seq(seq, edge_map):
    ...
    for node, seq_set in seq.iteritems():
        plist = []
        print(node)
...
def print_req(req, edge_map):
    ...
    for node, seq_set in req.iteritems():
        plist = []
        print(node)
...
def check_seq_req_balance(seq, req, edge_map = None):
    ...
    for node, req_set in req.iteritems():
...
def push_solve_inplace(
    ...
    for inode, val in inputs_map.iteritems():
