...
class ForceReadout(readouts.DCReadout, elements.ElectricalElementBase):
    ...
    def system_setup_ports(self, ports_algorithm):
        ...
        for port1 in ports:
            for kfrom in ports_algorithm.port_update_get(port1):
                ports_algorithm.port_coupling_needed(self.F.o, kfrom)
...
class DisplacementReadout(readouts.DCReadout, elements.ElectricalElementBase):
